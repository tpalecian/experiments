...
const CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'waterRippleFreq', label: 'Shore ripple freq', kind: 'range', min: 0.3, max: 4, step: 0.05, tags: ['bruno', 'ripple'] },
      { key: 'waterRippleSpeed', label: 'Shore ripple speed', kind: 'range', min: 0, max: 1.2, step: 0.02, tags: ['bruno'] },
      { key: 'waterRippleIntensity', label: 'Shore ripples', kind: 'range', min: 0, max: 1.2, step: 0.05, tags: ['bruno'] },
      { key: 'waterDriftIntensity', label: 'Drift waves', kind: 'range', min: 0, max: 1.2, step: 0.05, tags: ['bruno', 'wave'] },
      { key: 'waterDriftScale', label: 'Drift scale', kind: 'range', min: 0.05, max: 0.8, step: 0.01, tags: ['bruno'] },
      { key: 'waterDriftSpeed', label: 'Drift speed', kind: 'range', min: 0, max: 1.2, step: 0.05, tags: ['bruno'] },
    ],
  },
  {
    id: 'hexBoard',
